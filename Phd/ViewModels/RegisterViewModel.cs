...
namespace Phd.ViewModels
{
    public class RegisterViewModel
    {
        ...
        public int DisCouncilId { get; set; } // добавлено zhanjkee

        public int CertificationCommissionId { get; set; } // добавлено мной по аналогии
        // public int BRExamCommissionId { get; set; } // добавлено мной по аналогии // завязка пользователя на кафдедру
