...
namespace Phd.Controllers
{
    public class BMajorsController : BaseController
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                return View(await phdContext.Where(x=>x.AcademicDepartmentId == GetUser().BRExamCommissionId).ToListAsync());
            }
        ...
        {
            ViewData["AcademicDepartmentId"] = new SelectList(Context.AcademicDepartment, "Id", "Id");
            return View();
        }
