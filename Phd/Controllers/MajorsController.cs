...
namespace Phd.Controllers
{
    public class MajorsController : Controller
    {
        ...
        public MajorsController(PhdContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,MajorCypher,MajorCypherName,MajorCypherNameKaz,MajorCypherNameEng")] Major major)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MajorCypher,MajorCypherName,MajorCypherNameKaz,MajorCypherNameEng")] Major major)
        {
            if (id != major.Id)
            {
                return NotFound();
