...
namespace Phd.Controllers
{
    public class AccountController : Controller
    {
        ...
        public IActionResult Register()
        {
            ...
            //return View(); 
            //
            ViewData["DisCouncilId"] = new SelectList(_context.DisCouncil, "Id", "OrderNumber");
            ViewData["CertificationCommissionId"] = new SelectList(_context.CertificationCommission, "Id", "Name");
        ...
        public async Task<IActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                { 
                    ...
                    DisCouncilId = model.DisCouncilId,
                    CertificationCommissionId = model.CertificationCommissionId,
